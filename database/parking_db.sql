...
--
-- Dumping data for table `parking_list`
--

INSERT INTO `parking_list` (`id`, `category_id`, `location_id`, `ref_no`, `vehicle_brand`, `vehicle_registration`, `owner`, `vehicle_description`, `status`, `amount_due`, `amount_tendered`, `amount_change`, `date_created`) VALUES
...
INSERT INTO `time_stamp` (`id`, `pl_id`, `status`, `created_timestamp`) VALUES
...
--
-- Indexes for table `parking_list`
--
...
--
-- AUTO_INCREMENT for table `parking_list`
--
ALTER TABLE `parking_list`
