...
<div class="containe-fluid">
    <div class="row mt-3 mb-3 pl-5 pr-5">
        <div class="col-md-4 offset-md-2">
            <div class="card bg-secondary" style="background-color:red;">
                <div class="card-body text-white style=background:blue">
                    <span class="float-right summary_icon"><i class="fa fa-car"></i></span>
                    <h4><b>
                        <?php echo $conn->query("SELECT * FROM parking_list where status = 1")->num_rows; ?>
                    </b></h4>
        ...
        <div class="col-md-4">
            <div class="card bg-dark">
                <div class="card-body text-white">
                    <span class="float-right summary_icon"><i class="fa fa-car"></i></span>
                    <h4><b>
                        <?php echo $conn->query("SELECT * FROM parking_list where status = 2")->num_rows; ?>
                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-2">
                                <table class="table table-bordered">
                                    <tr>
                                        <th class="text-center">Parking Sections</th>
                                    ...
                                    while($lrow= $location->fetch_assoc()):
                                        $in = $conn->query("SELECT * FROM parking_list where status = 1 and location_id = ".$lrow['id'])->num_rows;
